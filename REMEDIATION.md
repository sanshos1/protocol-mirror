...
| Expose full workflow in the repository app | Public UI implements file, audit, respond, review response, finalize expired, and readback | Production build `d3d33bd` serves the corrected address, all lifecycle actions, FINALIZED waiting, and canonical readback | PASS |
